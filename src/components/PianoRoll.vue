<!--
    ...
    This component is inspired by and referenced based on
    AI Duet's implementation of the same feature
        ...
        keyDown(noteEvent) {
            ...
            if (this.$store.getters.getClockStatus) {
                ...
                if (document.getElementsByClassName(noteInput.replace('#', 's'))[0]) {
                    ...
                    const plane = new THREE.Mesh(geometry, (noteEvent.player == playerType.AGENT) ?
                        agentMaterial : humanMaterial);
                    const noteWidth =
